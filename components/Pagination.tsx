    ...
    <div className="flex items-center justify-center space-x-1 pt-8">
      ...
      {getPageNumbers().map((page, index) => {
        ...
        return (
          <button
            key={page}
            onClick={() =>
              page !== currentPage && handlePageClick(page as number)
            }
      ...
      >
        <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 20 20">
          <path
            fillRule="evenodd"
            d="M10.293 16.707a1 1 0 01-1.414 0l-6-6a1 1 0 010-1.414l6-6a1 1 0 011.414 1.414L5.414 9H18a1 1 0 110 2H5.414l4.293 4.293a1 1 0 010 1.414z"
            clipRule="evenodd"
